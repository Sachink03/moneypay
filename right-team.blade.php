    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap w-full justify-between">
                <div>
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Right team</h5>
                    <!--end::Page Title-->
                </div>
                <div>
    ...
    <div class="wizard wizard-4 mbl-top-135" id="kt_wizard_v4" data-wizard-state="step-first"
        ...
        <div class="container-fluid">
            <div class="row d-flex justify-content-center">
                    ...
                    <form action="{{ route('user.right-team') }}" method="GET" style="    width: 100%;">
                        <div class="row">
                            <div class="col-xl-4">
                            ...
                            <div class="col-3">
                                <div class="form-group mb-3">
                                    <a href="{{ route('user.right-team') }}" style="padding: 0.6rem 2rem;"
                                        name="reset"
                                        class="btn btn-outline-theme btn-lg d-block w-100 btn-primary"
                                        value="Reset">Reset</a>
                                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $value->created_at }}</td>
                                          <td>{{currency()}} {{ $value->investment->sum('amount') }}</td>
                                            <td> {{ $value->investment->sum('amt') }}</td>

                                        <td><span
                                            style="background:{{($value->active_status=='Active')?'#1f9a00':'#e33838'}};padding: 5px;
                                            border-radius: 5px;">{{$value->active_status}}</span>
                                    </td>
