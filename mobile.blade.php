                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group mt-2 mb-3 text-left">
                                        ...
                                        <input type="number" name="amount" min="49" id="PACKAGE_AMT"
                                            class="form-control" placeholder="Select Amount" value="">
                                    </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group mt-2 mb-3 text-left">
                                        ...
                                        <input type="tel" name="number" class="form-control" placeholder="Mobile Number"
                                            required value="">
                                    </div>
                                </div>
