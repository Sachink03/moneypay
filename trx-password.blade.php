                                                ...
                                                <div class="update-form">
                                                    <div class="form-group">
                                                        <label for="oldloginpassword">Old Password</label>
                                                            ...
                                                            <input type="password" class="form-control" id="oldloginpassword" placeholder="Old Password" name="old_password">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="newloginpassword">New Password</label>
                                                            ...
                                                            <input type="password" class="form-control" id="newloginpassword" placeholder="New Password" name="password">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="confloginpassword">Repeat Password</label>
                                                                                                                <div class="input-group">
                                                            
                                                            <input type="password" class="form-control" id="confloginpassword" placeholder="Retype New Password" name="password_confirmation">
                                                        </div>
                                                    </div>
